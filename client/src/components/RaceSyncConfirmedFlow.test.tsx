...
describe("Race sync confirmed flow", () => {
  it("pendingからCONFIRMEDへの同期後にTRUTH PANELと履歴指標を同時に更新する", () => {
    ...
    expect(confirmed).toContain("1件を保存");
  });
});
