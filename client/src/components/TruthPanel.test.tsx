...
const confirmedRace = {
  ...
  horses: [
    { no: 4, name: "オンベイト", style: "先行", withdrawn: false, abilities: { speed: 70, stamina: 60, start: 60, form: 60, going_rates: {}, mapping_status: "OK" }, model: { v23k_score: 70, ai_rank: 1, win_prob_calibrated: 0.3, top3_prob: 0.6, prob_status: "CALIBRATED" }, market: { popularity: 1, win_odds: 3, slot: null, captured_at: null }, record: {} },
    { no: 5, name: "ラクリメ", style: "差し", withdrawn: false, abilities: { speed: 65, stamina: 60, start: 60, form: 60, going_rates: {}, mapping_status: "OK" }, model: { v23k_score: 65, ai_rank: 2, win_prob_calibrated: 0.2, top3_prob: 0.5, prob_status: "CALIBRATED" }, market: { popularity: 5, win_odds: 9, slot: null, captured_at: null }, record: {} },
  ],
